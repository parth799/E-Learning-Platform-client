  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient text-cyan-700">Elerning?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Elerning, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of Elerning, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created Elerning &ndash; to provide new programmers
          ...
          <br />
          <br />
          At Elerning, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Elerning is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Elerning by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the Elerning family today and let&apos;s
        ...
        <br />
        <span className="text-[22px]">Parth Desai</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Elerning
        </h5>
        <br />
        <br />
        <br />
